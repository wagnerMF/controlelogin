...
<body>
    ...
    <form action="formulario.php" method="POST">
            <fieldset>
                ...
                <br>
                <div class="inputBox">
                    <input type="text" name="login" id="login" class="inputUser" maxlength="12" required>
                    <label for="login" class="labelInput">Nome do usuario</label>
                </div>
                <br>
                <div class="inputBox">
                    <input type="text" name="senha" id="senha" class="inputUser" maxlength="12" required >
                ...
                <br><br>
                  <input type="submit" name="submit" id="submit"  onclick="limpar()">
